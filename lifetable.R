# The code below is NOT my own work.
# I used the functions in this file to construct life tables.
# The author is Kendy Teng.
# It is accessed from a open-access GitHub repository.
# The repository can be git cloned via https://github.com/kendyteng/OpenAccess.git.
